...
class MwUtil:
    ...
    def import_from_string(import_name: str, silent: bool = False):
        ...
        try:
            ...
            if not silent:
                error = "Class path not found: " + import_name
                error += "\n" + str(e)
                raise MwException(error)

        return None

    @staticmethod
    def is_sub_class_of(child_class, parent_class, raise_exception=True, message="Not subclass") -> bool:
